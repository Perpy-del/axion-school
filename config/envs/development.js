module.exports = {
  ...
  MONGO_URI: process.env.MONGO_URI_DEV || "mongodb://localhost:27017/axion-dev",
  REDIS_URI: process.env.REDIS_URI_DEV || "redis://localhost:6379",
  CACHE_REDIS: process.env.CACHE_REDIS_DEV || null,
